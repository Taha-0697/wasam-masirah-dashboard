...
import { RoleIsActiveCell } from './RoleIsActiveCell';
...
const rolesColumns = [
  ...
  columnHelper.accessor('isActive', {
    header: (props) => <RoleCustomHeader tableProps={props} localizedKey='FIELDS.ACTIVE' />,
    cell: (props) => <RoleIsActiveCell isActive={props.getValue()} />,
  }),
