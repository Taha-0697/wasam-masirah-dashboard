...
export interface PageDataContextModel {
  ...
  setPageBreadcrumbs: (_breadcrumbs: PageLink[]) => void;
}

const PageDataContext = createContext<PageDataContextModel>({
  setPageTitle: (_title: string) => {},
  setPageBreadcrumbs: (_breadcrumbs: PageLink[]) => {},
...
const BreadCrumbs: FC<Props & WithChildren> = ({ breadcrumbs }) => {
...
export { PageDescription, PageTitle, PageDataProvider, usePageData, BreadCrumbs };
